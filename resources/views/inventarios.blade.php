                                ...
                                @if(isset($inventarios))
                                    ...
                                    @foreach($inventarios as $inventario)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="inventario/{{$inventario->id}}">Ver articulos</a></td>
                                        </tr>
                                        </tbody>
                                    @endforeach
                                @elseif((isset($articulos)))

                                    <h3>Articulos de {{$articulos->nombre}}</h3>
                                    <thead>
                                    <tr>
                                        <th>Descripcion</th>
                                        <th>Ubicacion</th>
                                    ...
                                    @endforeach
                                @else
                                    <h3>Movimientos de {{$movimientos->descripcion}}</h3>
                                    <thead>
                                    <tr>
                                        <th>Cantidad</th>
                                        <th>Tipo</th>
